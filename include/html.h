...
static const char requestURL[] PROGMEM = "https://dev.otoma.my.id/api/nexusControllerRequest.php";
static const char identifyURL[] PROGMEM = "https://dev.otoma.my.id/api/identifyDevice.php";
